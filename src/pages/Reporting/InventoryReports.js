...
const InventoryReport = () => {
  ...
  // Dummy data for inventory report
  const dummyData = [
    { item: 'Laptop', quantity: 20, movement: 'In Stock' },
    { item: 'Monitor', quantity: 15, movement: 'Sold' },
    { item: 'Keyboard', quantity: 100, movement: 'In Stock' },
    { item: 'Mouse', quantity: 50, movement: 'In Stock' },
    { item: 'Printer', quantity: 5, movement: 'Sold' },
  ];

  useEffect(() => {
    // Simulate fetching inventory data with a delay
