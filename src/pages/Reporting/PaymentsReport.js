...
const PaymentsReport = () => {
  ...
  // Dummy data for payments report
  const dummyData = [
    { name: 'John Doe', outstanding: 150.0, balance: 300.0 },
    { name: 'Jane Smith', outstanding: 200.0, balance: 400.0 },
    { name: 'Sam Wilson', outstanding: 100.0, balance: 250.0 },
    { name: 'Mike Johnson', outstanding: 50.0, balance: 150.0 },
    { name: 'Alice Brown', outstanding: 0.0, balance: 500.0 },
  ];

  useEffect(() => {
    // Simulate fetching payment data with a delay
